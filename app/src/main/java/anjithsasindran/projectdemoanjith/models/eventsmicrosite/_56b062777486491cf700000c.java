...
public class _56b062777486491cf700000c {
    ...
    @Expose
    private List<SectionDatum____> sectionData = new ArrayList<SectionDatum____>();
     ...
     */
    public List<SectionDatum____> getSectionData() {
        return sectionData;
    }
     ...
     */
    public void setSectionData(List<SectionDatum____> sectionData) {
