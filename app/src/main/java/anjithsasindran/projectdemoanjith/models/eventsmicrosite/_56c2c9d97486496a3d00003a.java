...
public class _56c2c9d97486496a3d00003a {
    ...
    @Expose
    private List<AssociatedPerson___> associatedPeople = new ArrayList<AssociatedPerson___>();
     ...
     */
    public List<AssociatedPerson___> getAssociatedPeople() {
     ...
     */
    public void setAssociatedPeople(List<AssociatedPerson___> associatedPeople) {
