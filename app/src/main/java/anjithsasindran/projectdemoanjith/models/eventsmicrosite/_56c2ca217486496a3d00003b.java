...
public class _56c2ca217486496a3d00003b {
    ...
    @Expose
    private List<AssociatedPerson____> associatedPeople = new ArrayList<AssociatedPerson____>();
     ...
     */
    public List<AssociatedPerson____> getAssociatedPeople() {
     ...
     */
    public void setAssociatedPeople(List<AssociatedPerson____> associatedPeople) {
