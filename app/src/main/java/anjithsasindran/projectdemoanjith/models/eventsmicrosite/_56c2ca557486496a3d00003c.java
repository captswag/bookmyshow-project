...
public class _56c2ca557486496a3d00003c {
    ...
    @Expose
    private List<AssociatedPerson_____> associatedPeople = new ArrayList<AssociatedPerson_____>();
     ...
     */
    public List<AssociatedPerson_____> getAssociatedPeople() {
     ...
     */
    public void setAssociatedPeople(List<AssociatedPerson_____> associatedPeople) {
