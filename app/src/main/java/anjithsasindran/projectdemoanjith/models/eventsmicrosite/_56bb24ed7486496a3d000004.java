...
public class _56bb24ed7486496a3d000004 {
    ...
    @Expose
    private List<AssociatedPerson> associatedPeople = new ArrayList<AssociatedPerson>();
     ...
     */
    public List<AssociatedPerson> getAssociatedPeople() {
     ...
     */
    public void setAssociatedPeople(List<AssociatedPerson> associatedPeople) {
